...
Subscriber.create!(group_id: g2.id, user_id: u4.id, admin: true)
Subscriber.create!(group_id: g2.id, user_id: u5.id, admin: false)
Subscriber.create!(group_id: g2.id, user_id: u6.id, admin: false)

Subscriber.create!(group_id: g3.id, user_id: u3.id, admin: true)
Subscriber.create!(group_id: g3.id, user_id: u6.id, admin: false)
Subscriber.create!(group_id: g3.id, user_id: u1.id, admin: false)
